        ...
        <View style={styles.bg}>
            <View style={styles.top}>
                ...
                <View style={homeStyles.tabContainer}>
                    <TouchableOpacity style={isNormal ? homeStyles.tabActive : homeStyles.tabNormal} onPress={() => {
                        setIsNormal(true);
                    }}><Image style={homeStyles.tabIcon}
                              source={require('../assets/images/icon_tab_left.png')}/></TouchableOpacity>
                    <TouchableOpacity
                        style={isNormal ? homeStyles.tabNormal : homeStyles.tabActive} onPress={() => {
                        setIsNormal(false);
                    }}><Image style={homeStyles.tabIcon}
                              source={require('../assets/images/icon_tab_right.png')}/></TouchableOpacity>
                </View>
            ...
            {isNormal ?
                ...
                </> : <StoreList initialData={restaurantsData}/>}
...
const homeStyles = StyleSheet.create({
    tabContainer: {
        backgroundColor: 'rgb(243,196,91)',
        height: 40,
        width: 100,
        borderRadius: 21,
        flexDirection: 'row',
    ...
    tabActive: {
        flex: 1,
        backgroundColor: 'rgb(241,211,124)',
        height: 38,
        width: 50,
        borderRadius: 20,
        overflow: 'hidden',
